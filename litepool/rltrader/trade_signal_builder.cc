...
void TradeSignalBuilder::compute_trade_signals(const TradeInfo& info, const double& bid_price, const double& ask_price) {
    ...
    double gross_trade = info.buy_trades + info.sell_trades;
    ...
    previous_repo.buy_amount_ratio = repo.buy_amount_ratio;
    previous_repo.buy_num_trade_ratio =repo.buy_num_trade_ratio;
    previous_repo.relative_buy_price = repo.relative_buy_price;
    previous_repo.relative_sell_price = repo.relative_sell_price;
    previous_repo.sell_amount_ratio = repo.sell_amount_ratio;
    previous_repo.sell_num_trade_ratio = repo.sell_num_trade_ratio;
}
