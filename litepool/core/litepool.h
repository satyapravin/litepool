...
#ifndef LITEPOOL_CORE_LITEPOOL_H_
#define LITEPOOL_CORE_LITEPOOL_H_
...
/**
 * Templated subclass of LitePool, to be overrided by the real LitePool.
 */
...
class LitePool {
 public:
  ...
  explicit LitePool(EnvSpec spec) : spec(std::move(spec)) {}
  virtual ~LitePool() = default;
...
#endif  // LITEPOOL_CORE_LITEPOOL_H_
