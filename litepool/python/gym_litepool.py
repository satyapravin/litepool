...
"""LitePool meta class for gym.Env API."""
...
class GymLitePoolMeta(ABCMeta, gym.Env.__class__):
  """Additional wrapper for LitePool gym.Env API."""

  def __new__(cls: Any, name: str, parents: Tuple, attrs: Dict) -> Any:
    """Check internal config and initialize data format convertion."""
    base = parents[0]
    parents = (base, GymLitePoolMixin, LitePoolMixin, gym.Env)
