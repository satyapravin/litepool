...
class LitePool(Protocol):
  """Cpp PyLitepool class interface."""
  ...
  def recv(
    ...
    """Litepool recv wrapper."""

  def async_reset(self) -> None:
    """Litepool async reset interface."""
  ...
  def step(
    ...
    """Litepool step interface that performs send/recv."""

  def reset(
    self,
    env_id: Optional[np.ndarray] = None,
  ) -> Union[TimeStep, Tuple]:
    """Litepool reset interface."""
