...
"""LitePool meta class for dm_env API."""
...
class DMLitePoolMeta(ABCMeta):
  """Additional wrapper for LitePool dm_env API."""

  def __new__(cls: Any, name: str, parents: Tuple, attrs: Dict) -> Any:
    """Check internal config and initialize data format convertion."""
    base = parents[0]
    parents = (
        base, DMLitePoolMixin, LitePoolMixin, dm_env.Environment
    )
