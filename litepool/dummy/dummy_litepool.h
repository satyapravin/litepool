...
#ifndef LITEPOOL_DUMMY_DUMMY_LITEPOOL_H_
#define LITEPOOL_DUMMY_DUMMY_LITEPOOL_H_
 ...
 */
using DummyLitePool = AsyncLitePool<DummyEnv>;

}  // namespace dummy

#endif  // LITEPOOL_DUMMY_DUMMY_LITEPOOL_H_
